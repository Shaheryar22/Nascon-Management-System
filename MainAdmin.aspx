<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainAdmin.aspx.cs" Inherits="NASCON_MS.MainAdmin" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="btn-container">
                ...
                <asp:Button ID="btnRemoveEvent" runat="server" Text="Remove Event" CssClass="btn" OnClick="btnRemoveEvent_Click" />
                <asp:Button ID="btnAddFacultyMentor" runat="server" Text="Add Faculty Mentor" CssClass="btn" OnClick="btnAddFacultyMentor_Click" />
                <asp:Button ID="btnAddStudentTeam" runat="server" Text="Add Student (Team)" CssClass="btn" OnClick="btnAddStudentTeam_Click" />
