        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="btn-container">
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn cancel-btn" OnClientClick="window.location.href='your_cancel_url_here';" OnClick="btnCancel_ClickS" />
                    <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="btn submit-btn" OnClick="btnLogin_ClickS" />
                </div>
