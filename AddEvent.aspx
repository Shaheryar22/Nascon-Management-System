<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEvent.aspx.cs" Inherits="NASCON_MS.AddEvent" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div>
                    <asp:Label runat="server" AssociatedControlID="eventID" Text="Event ID:"></asp:Label>
                    <asp:TextBox ID="eventID" runat="server" CssClass="form-control" placeholder="Enter event ID"></asp:TextBox>
                </div>
                <div>
                    <asp:Label runat="server" AssociatedControlID="date" Text="Date:"></asp:Label>
                    <asp:TextBox ID="date" runat="server" CssClass="form-control" placeholder="Enter date" />
                </div>
                <div>
                    <asp:Label runat="server" AssociatedControlID="time" Text="Time:"></asp:Label>
                    <asp:TextBox ID="time" runat="server" CssClass="form-control" placeholder="Enter time" />
                </div>
                <div>
                    <asp:Label runat="server" AssociatedControlID="mentor" Text="Mentor:"></asp:Label>
                    <asp:TextBox ID="mentor" runat="server" CssClass="form-control" placeholder="Enter mentor name"></asp:TextBox>
                </div>
