...
<body>
    <form id="form1" runat="server">
        ...
        <div class="wrapper">
            <div class="container">
                <h2 class="log">Registration Participant</h2>
                <div>
                ...
                <div>
                    ...
                    <asp:DropDownList ID="gender" runat="server" CssClass="form-control" OnSelectedIndexChanged="gender_SelectedIndexChanged">
                ...
                <div style="width: 100%;">
                    ...
                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn submit-btn" OnClick="btnSubmit_Click" />
                </div>
