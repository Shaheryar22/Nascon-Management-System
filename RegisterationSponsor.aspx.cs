...
namespace NASCON_MS
{
    public partial class Registeration : System.Web.UI.Page
    {
        ...
        protected void Page_LoadRS(object sender, EventArgs e)
        {

        }

        protected void btnSubmit_ClickRS(object sender, EventArgs e)
        {
     ...
     VALUES
        ...
        protected void btnCancel_ClickRS(object sender, EventArgs e)
        {

        }

        protected void gender_SelectedIndexChangedRS(object sender, EventArgs e)
        {
