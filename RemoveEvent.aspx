<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoveEvent.aspx.cs" Inherits="NASCON_MS.RemoveEvent" %>
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div style="width: 100%;">
                    ...
                    <asp:Button ID="btnSubmit" runat="server" Text="Remove" CssClass="btn submit-btn" OnClick="btnRemove_Click" />
                </div>
