...
namespace NASCON_MS
{
    public partial class Registeration : System.Web.UI.Page
    {
        ...
        protected void Page_LoadP(object sender, EventArgs e)
        {

        }

        protected void btnSubmit_ClickP(object sender, EventArgs e)
        {
     ...
     VALUES
        ...
        protected void btnCancel_ClickP(object sender, EventArgs e)
        {

        }

        protected void gender_SelectedIndexChangedP(object sender, EventArgs e)
        {
