<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainFacultyMentor.aspx.cs" Inherits="NASCON_MS.MainFacultyMentor" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="btn-container">
                <asp:Button ID="btnViewEventDetails" runat="server" Text="View Event Details" CssClass="btn" OnClick="btnViewEventDetails_Click" />
                <asp:Button ID="btnViewEventTeam" runat="server" Text="View Event Team" CssClass="btn" OnClick="btnViewEventTeam_Click" />
                <asp:Button ID="btnLogout" runat="server" Text="Logout" CssClass="btn" OnClick="btnLogout_Click" />
                <asp:Button ID="btnFeedback" runat="server" Text="Feedback" CssClass="btn" OnClick="btnFeedback_Click" />
            </div>
        </div>
    </form>
</body>
