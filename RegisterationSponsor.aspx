<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registeration.aspx.cs" Inherits="NASCON_MS.Registeration" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="wrapper">
            <div class="container">
                <h2 class="log">Registration Sponsor</h2>
                <div>
                ...
                <div>
                    ...
                    <asp:DropDownList ID="gender" runat="server" CssClass="form-control" OnSelectedIndexChanged="gender_SelectedIndexChangedRS">
                ...
                <div style="width: 100%;">
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn cancel-btn" OnClientClick="window.location.href='your_cancel_url_here';" OnClick="btnCancel_ClickRS" />
                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn submit-btn" OnClick="btnSubmit_ClickRS" />
                </div>
