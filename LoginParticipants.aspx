...
<body>
    <form id="form1" runat="server">
        ...
        <div class="wrapper">
            <div class="container">
                <h2 class="log">Login Participant</h2>
                <div>
                ...
                <div class="btn-container">
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn cancel-btn" OnClientClick="window.location.href='your_cancel_url_here';" OnClick="btnCancel_ClickP" />
                    <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="btn submit-btn" OnClick="btnLogin_ClickP" />
                </div>
                <div class="signup-text">
                    Don't have an account? <a href="RegisterationParticipant.aspx">Register</a>
                </div>
            </div>
        </div>
    </form>
