<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainSponsor.aspx.cs" Inherits="NASCON_MS.MainSponsor" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="btn-container">
                <asp:Button ID="btnViewEvent" runat="server" Text="View Event" CssClass="btn" OnClick="btnViewEvent_Click" />
                <asp:Button ID="btnSponsoredEventsList" runat="server" Text="Sponsored Events List" CssClass="btn" OnClick="btnSponsoredEventsList_Click" />
